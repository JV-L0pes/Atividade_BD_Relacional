...
-- Índice geoespacial comentado - requer extensão earthdistance ou postgis
-- CREATE INDEX IF NOT EXISTS idx_localizacao_coordenadas ON localizacao USING GIST (ll_to_earth(latitude, longitude));
